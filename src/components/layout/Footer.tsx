/**
 * Honey Bee â€” Footer
 * Stitch "Luminous Alchemist" â€” surface-container background, 4-column layout,
...
export function Footer() {
  ...
  return (
    <footer className="bg-[#f0ede8]">
      ...
      {/* Bottom bar â€” no visible divider, just tonal shift */}
      <div className="bg-[#ebe8e3] px-6 md:px-20 py-5 flex flex-col md:flex-row justify-between items-center gap-3">
        <p className="font-body text-xs text-[#4f4634]">
          Â© {currentYear} Honey Bee. All rights reserved. Handcrafted with intention.
        </p>
